...
# Experiment Name
experiment = 'positional-encoding-eval'
...
for positional_encoding_method in ['constant', 'monotonic', 'transformer', 'graph']:
    experiment = positional_encoding_method + '-' + experiment
    dataset_creation_parameters['positional_encoding_method'] = positional_encoding_method
