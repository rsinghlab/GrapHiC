...
# Experiment Name
base_experiment = 'epigenetic-feature-eval'
...
for epi_set in epigenetic_features.keys():
    experiment = '{}-{}'.format(epi_set, base_experiment)
    
    print(epigenetic_features[epi_set])
    ...
    node_encoding_files = get_required_node_encoding_files_paths('GM12878', epigenetic_features[epi_set])
