...
#parse_out_all_hic_files(os.path.join(PATH_TO_HIC_RAW_FILES, 'IMR90', 'GeoAccession'))
#parse_out_all_hic_files(os.path.join(PATH_TO_HIC_RAW_FILES, 'K562', 'GeoAccession'))
